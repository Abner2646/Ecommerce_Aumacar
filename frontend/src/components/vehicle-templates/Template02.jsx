...
export default function Template02({ vehiculo, caracteristicas: caracteristicasProp, colores: coloresProp }) {
  ...
  return (
    <div className="template-02-magazine bg-black">
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          ...
          {imagenesOrdenadas.length > 0 ? (
            <div className="space-y-12">
              ...
              {/* Grid de imágenes - Primeras 3 */}
              <div className="grid md:grid-cols-3 gap-6">
                {imagenesOrdenadas.slice(0, 3).map((imagen, index) => (
                  <div
                    key={imagen.id}
              ...
              {/* Imágenes expandidas */}
              {showAllImages && imagenesOrdenadas.length > 3 && (
                <div className="expanded-images grid md:grid-cols-3 gap-6">
                  {imagenesOrdenadas.slice(3).map((imagen, index) => (
                    <div
                      key={imagen.id}
                      className="gallery-image-wrapper aspect-[4/3] rounded-lg"
                      onClick={() => setModalImage(imagen.url)}
              ...
              {imagenesOrdenadas.length > 3 && (
                <div className="text-center pt-8">
                  ...
                  >
                    <span className="text-sm font-bold uppercase tracking-wider">
                      {showAllImages ? 'Ver menos' : `Ver más (${imagenesOrdenadas.length - 3} imágenes)`}
                    </span>
                    <svg 
      ...
      {/* ============================================ */}
      {/* SECCIÓN 3: STATEMENT SECTION (NUEVO) */}
      {/* ============================================ */}
      {imagenesOrdenadas.length > 0 && (
          ...
          <div className="relative h-full flex items-center justify-center px-8">
            <div className="max-w-4xl text-center space-y-8">
              ...
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-tight">
                Diseñado para <br/>
                <span className="text-gray-300">inspirar</span>
              </h2>
              
              <p className="text-xl md:text-2xl text-gray-300 font-light max-w-2xl mx-auto leading-relaxed">
                Donde la innovación se encuentra con la elegancia. 
                Cada detalle pensado para crear una experiencia excepcional.
              </p>
      ...
      {/* ============================================ */}
      {/* SECCIÓN 4: ESPECIFICACIONES COMPACTAS */}
      {/* ============================================ */}
      {specs.length > 0 && (
      ...
      {/* ============================================ */}
      {/* SECCIÓN 5: CARACTERÍSTICAS (SIN CAMBIOS) */}
      {/* ============================================ */}
      ...
      {/* ============================================ */}
      {/* SECCIÓN 6: CTA FINAL (SIN CAMBIOS) */}
      {/* ============================================ */}
