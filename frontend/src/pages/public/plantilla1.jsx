...
function Plantilla1({ marca }) {
  ...
  return (
    <main className="bg-white plantilla1-root">
      ...
      <section className="relative flex items-center hero-section-fix" style={{ minHeight: '100svh' }}>
        <div className="absolute inset-0 overflow-hidden">
          <video
            ...
            muted
            playsInline
            className="w-full h-full object-cover object-center block bg-black mobile-video-fix"
          />
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button
                ...
                onClick={() => {
                  const section = document.getElementById('linea-completa');
                  if (section) {
      ...
      {/* ==================== SECCIÓN 2: LÍNEA COMPLETA ==================== */}
      <section className="cns-section" id="linea-completa">
      ...
      <section className="cns-parallax hidden md:block">
        ...
        <div className="cns-container relative z-10 flex items-center min-h-[400px] md:min-h-[500px] py-20">
          <div className="max-w-2xl">
            ...
            {/* ❌ marca.nombre NO se traduce, texto alrededor SÍ */}
      ...
      <section className="cns-section bg-gray-50" id="caracteristicas">
        <div className="cns-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {/* ✅ Estas características SÍ se traducen */}
